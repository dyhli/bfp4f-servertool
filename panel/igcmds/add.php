...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['cmd']) && isset($_POST['func']) && isset($_POST['response']) && isset($_POST['rights'])) {
	...
	if(count($errors) == 0) {
		...
		$result = $igc->createCommand(array(
		...
		if($result == 'OK') {
			...
			$log->insertActionLog($userInfo['user_id'], 'Command ' . strtolower($_POST['cmd']) . ' added');
		} else {
...
?>
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3">
								<div class="checkbox">
									<label><input type="checkbox" name="response_priv" /> <span><?=$lang['tool_igcmds_help3']?></span></label>
								</div>
							</div>
 						</div>
...
?>
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3">
								<div class="checkbox">
									<label><input type="checkbox" name="active" checked /> <span><?=$lang['tool_igcmds_help4']?></span></label>
								</div>
							</div>
 						</div>
