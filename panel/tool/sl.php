...
// If form is posted
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['status']) && isset($_POST['ignvip']) && isset($_POST['kickmsg']) && isset($_POST['max'])) {
...
?>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<h2><i class="fa fa-ban"></i> <?=$lang['tool_sl']?> <small><?=$lang['tool_sl_desc']?></small></h2>
					<hr />

					<form action="<?=HOME_URL?>panel/tool/sl.php" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="status" class="selectpicker show-tick" data-width="100%" required>
									...
									<option value="true" data-icon="fa fa-check"<?=(($settings['tool_sl'] == 'true') ? ' selected' : '')?>><?=$lang['word_enabled']?></option>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="ignvip" class="selectpicker show-tick" data-width="100%" required>
									<option value="false" data-icon="fa fa-times"><?=$lang['word_disabled']?></option>
									<option value="true" data-icon="fa fa-check"<?=(($settings['tool_sl_ignorevip'] == 'true') ? ' selected' : '')?>><?=$lang['word_enabled']?></option>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="kickmsg" class="form-control" value="<?=$settings['tool_sl_msg']?>" required />
						...
						<div class="form-group">
							<label class="control-label col-sm-3"><i class="fa fa-exclamation"></i> <?=$lang['tool_sl_max']?></label>
							<div class="col-sm-9">
